...
captcha_image = driver.find_element(By.XPATH, '//*[@id="captchaimg"]')
...
textbox = driver.find_element(By.XPATH, '//*[@id="ca"]')
textbox.send_keys(captcha_text)

next_captcha = driver.find_element(By.XPATH, '/html/body/div[1]/div[1]/div[2]/div/c-wiz/div/div[2]/div/div[2]/div/div[1]/div/div/button')
next_captcha.click()
